...
export const TestResult = ({ data, results, answerNum }: TestResultProps) => {
    return (
        <React.Fragment>
                ...
                <React.Fragment>
                    ...
                    {answerNum === Object.keys(results).length && (
                        <div className="text-[#5f7f90] text-[12.25px] m-[4px_0] leading-5">
                            샘플 테스트 케이스를 통과했다는 의미로, 작성한 코드가 문제의 정답은 아닐 수 있습니다. <br /> (샘플 테스트 케이스는 [테스트 케이스
                            추가하기] 버튼을 통해 확인하실 수 있습니다.)
                        </div>
                    )}
                </React.Fragment>
            )}
