...
export const ModalContent = ({ onClick, content, questionId, status }: ModalContentProps) => {
    ...
    return (
        <React.Fragment>
            {preview ? (
                <React.Fragment>
                    <h5 className="text-[#263747] text-[26px] font-[700] leading-[1.4]">{form.title}</h5>
                ...
                <React.Fragment>
                    <div className="mb-[16px]">
                        ...
                        <input
                            ...
                            placeholder="입력하세요."
                            required={true}
                            className="w-[100%] p-[8px_12px] bg-[#fbfbfd] font-[400] text-[13px] md:text-[16px] leading-[24px] border-[1.5px] border-[#d7e2eb] rounded-[4px] placeholder:text-[rgba(50,50,80,0.24)] hover:border-[#0078FF]"
                        ></input>
                    </div>
            ...
            <div className="pt-[40px] flex flex-wrap justify-end">
                <button
                    className="bg-[#E9ECF3] text-[#263747] text-[14px] sm:text-[16px] font-[500] leading-[24px] p-[7px_13px] mx-[4px] rounded-[4px] hover:bg-[#D7E2EB]"
                    onClick={() => setPreview(!preview)}
                >
                    <h5 className="mt-0.5">{preview ? '편집하기' : '미리 보기'}</h5>
                </button>
                <button
                    className="bg-[#E9ECF3] text-[#263747] text-[14px] sm:text-[16px] font-[500] leading-[24px] p-[7px_13px] mx-[4px] rounded-[4px] hover:bg-[#D7E2EB]"
