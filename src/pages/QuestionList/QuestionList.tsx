...
export default function QuestionList() {
    ...
    return (
        <React.Fragment>
            <Navbar title={data.title} category={data.category} id={data.questionId} children="질문목록" />
                    ...
                    <div className="mt-[40px]">
                        ...
                        <div className="pb-[16px] border-dashed border-[#d7e2eb] border-b-[1px]">
                            ...
                            <div className="inline-block align-top w-[calc(100%-44px)] pl-[16px] cursor-pointer" onClick={() => setModal(true)}>
                                <h5 className="m-[1px_0_0_1px] leading-[1.6] p-[8px] text-[16px] text-[#b2c0cc] border-[1px] border-[#d7e2eb] rounded-[4px] hover:shadow-[0_0_0_2px_#0078FF]">
                                    질문을 작성하세요.
                                </h5>
                            </div>
                        </div>
