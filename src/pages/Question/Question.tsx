...
export default function Question() {
    ...
    return (
        <React.Fragment>
            ...
            <div className="h-[calc(100vh-50px-394px)] max-w-[1200px] m-[0_auto_0_auto]">
                <div className="p-[24px_0_40px_0] border-b-[1px] border-[#d7e2eb]">
                    <button
                        className="w-[147px] bg-[#EEEBFF] border-[#EEEBFF] border-b-[1px] rounded-[4px] text-[#0078FF] text-[16px] font-[600] mb-[32px] p-[7px] hover:bg-[#D8DDFF]"
                    ...
                    <div>
                        <div className="flex justify-between items-center">
                            ...
                            <button
                                className="bg-[#0078ff] text-[white] text-[16px] font-[500] p-[7px_13px] rounded-[4px] hover:bg-[#0053f4]"
                        ...
                        <div className="p-[24px_0_40px_0] max-w-[1200px] m-[0_auto_0_auto]">
                            <div className="box-border border-b border-slate-100" />
                            ...
                            <div className="mb-[8px]">
                                ...
                                <button className="mt-[20px] bg-[#0078ff] p-[7px_13px] hover:bg-[#0053f4] rounded-[4px]" onClick={onClick}>
                                    <h5 className="mt-0.5 text-[white] text-[16px] font-[500]">작성하기</h5>
                                </button>
                            </div>
                        </div>
                    </div>
