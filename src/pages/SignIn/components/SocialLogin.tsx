    ...
    return (
        <>
            ...
            <div className='flex justify-evenly text-center text-[0.75rem]'>
                <div>
                    <img src={google} className='w-[2.875rem] cursor-pointer'></img>
                    <div>Google</div>
                </div>
                <div>
                    <img src={kakao} className='w-[2.875rem] cursor-pointer'></img>
                    <div>Kakao</div>
                </div>
                <div>
                    <img src={github} className='w-[2.875rem] cursor-pointer'></img>
                    <div>Github</div>
                </div>
                <div>
                    <img src={facebook} className='w-[2.875rem] cursor-pointer'></img>
                    <div>Facebook</div>
                </div>
            </div>
        </>
