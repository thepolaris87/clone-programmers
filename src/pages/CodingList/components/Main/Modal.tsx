    ...
    return (
        <div className="absolute w-full sm:w-[334px] top-[3.2rem] right-2 bg-white sm:shadow-xl rounded-2xl">
            ...
            <div className="bg-[#f6faff] flex flex-col items-center gap-4">
                ...
                <div className='w-[245px] p-[12px] rounded mb-[30px] border border-[#d7e2db] text-center text-[14px] bg-white'>프로필 등록하기</div>
            </div>
            <div className='flex flex-col self-center bg-center'>
            <div className='h-[84px] text-[18px] font-semibold leading-[24px] mx-[20px] justify-center cursor-pointer pt-7' onClick={() => navigate('/my-page')}>마이페이지</div>
            <div className='h-[84px] text-[18px] font-semibold leading-[24px] mx-[20px] justify-center border-t border-[#efefef] cursor-pointer pt-7'onClick={onLogout}>로그아웃</div>
            </div>
        </div>
    );
}
