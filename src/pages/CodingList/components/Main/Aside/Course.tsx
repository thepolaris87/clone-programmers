  ...
  return (
    <div className="grid grid-cols-5 mb-[1.1875rem]">
      ...
      <div className="col-span-3">
        <div className="font-semibold flex pr-3 text-[0.875rem] cursor-pointer">{props.title}</div>
        <div className="flex text-[0.625rem] gap-[0.375rem] pt-1">
          <div className="px-[0.5rem] bg-course_box rounded cursor-pointer">{props.level}</div>
          <div className="px-[0.5rem] bg-course_box rounded cursor-pointer">{props.lang}</div>
        </div>
      </div>
    </div>
  );
