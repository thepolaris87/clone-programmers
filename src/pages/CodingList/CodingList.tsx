              ...
              <table className=" w-full ">
                <thead className="">
                  <tr className="text-[0.75rem] text-[#98A8B9] p-[0.5625rem] border-b border-list_border">
                    ...
                    <th className="w-[5rem] text-center p-[0.5625rem]">
                      난이도
                    </th>
                    <th className="w-[6.25rem] text-right p-[0.5625rem]">
                      완료한 사람
                    </th>
                    <th className="w-[5rem] text-right p-[0.5625rem]">
                      정답률
                    </th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="items-center border-b border-list_border p-[0.5625rem]">
                    ...
                    <td>제목</td>
                    <td className="text-center text-[#2189FF] font-bold">
                      난이도
                    </td>
          ...
          <aside className="border border-list_border rounded-2xl w-1/3">
            <div className="border-b border-list_border text-center items-center py-[2rem]">
              <div className="font-extrabold text-[1rem]">
                로그인하고 코딩테스트 연습을 시작하세요!
              </div>
              <div className="flex justify-center items-center">
                <div className=" bg-btn_blue w-[6.25rem] h-[2.875rem] text-center text-white font-extrabold rounded-md mt-[1rem] pt-3 cursor-pointer"
            ...
            <div className="border-b border-list_border">
              ...
              <Course
                src={course3}
                title="[도서실습] 내일은 코딩테스트 with 파이썬(자료구조와 알고리즘의 기초부터 실전까지)"
              />
            </div>
            <div className="flex items-center p-[1.5rem]">
